...
interface ChatBubbleProps {  // Updated name for the props interface
    error: Error;
}

const ChatBubble: React.FC<ChatBubbleProps> = ({ error }) => {  // Updated component name
...
export default ChatBubble;  // Updated export name
