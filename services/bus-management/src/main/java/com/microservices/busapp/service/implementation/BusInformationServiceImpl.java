...
import com.microservices.busapp.mapper.TrajetMapper;
import com.microservices.busapp.mapper.TravelInformationMapper;
...
public class BusInformationServiceImpl implements BusInformationService {
    ...
    public BusInformationDto updateTravel(Long id, BusInformationDto informationDto) {
        ...
        travel.setTrajets(trajets.stream()
                .map(trajetMapper::toEntity)
